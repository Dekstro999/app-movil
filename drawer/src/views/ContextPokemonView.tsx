...
import { usePokemonContext } from "../state/pokemon-context";

export default function ContextPokemonView() {
  const { pokemon, isLoading, error, loadRandomPokemon } = usePokemonContext();
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Context API</Text>
      <Text style={styles.description}>Estado global usando Provider + useContext</Text>
